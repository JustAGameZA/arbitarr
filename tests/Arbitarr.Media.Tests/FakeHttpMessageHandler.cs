...
/// from <c>Arbitarr.Sources.NzbHydra.Tests</c> (no mocking library referenced by either test
/// project) so <see cref="Arbitarr.Media.Providers.AnimeListsProvider"/> can be exercised without
