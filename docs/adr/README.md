...
| [0012](0012-lan-passthrough-optional-login.md) | LAN passthrough admits a trusted local-network peer as a full-scope operator without a session or API key, on by default |
