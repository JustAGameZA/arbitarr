...
/// <param name="SourceName">Stable name identifying this source instance (used for rate limiting keying, circuit-breaker lookups, and <see cref="Arbitarr.Core.Sources.IUpstreamSource.Name"/>).</param>
