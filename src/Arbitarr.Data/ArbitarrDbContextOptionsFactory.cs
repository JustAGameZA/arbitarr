...
/// <summary>
/// Builds <see cref="DbContextOptions{TContext}"/> for <see cref="ArrSearcherDbContext"/> backed
...
/// </summary>
public static class ArrSearcherDbContextOptionsFactory
{
    /// <summary>
    ...
    /// <see cref="ArrSearcherDbContext"/>. The caller owns disposing the resulting context
    ...
    /// </summary>
    public static DbContextOptions<ArrSearcherDbContext> Create(SqliteConnectionFactory connectionFactory)
    {
        var connection = connectionFactory.OpenConnection();

        return new DbContextOptionsBuilder<ArrSearcherDbContext>()
