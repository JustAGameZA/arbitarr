...
/// <summary>
/// #44: resolves a presented session cookie to the SAME <see cref="CredentialResolution"/> a
...
/// <see cref="CredentialResolution"/> carrying an <see cref="ApiKeyScope"/>, and
...
///
/// <para><b>NOT A REPLACEMENT FOR <see cref="ICredentialResolver"/>.</b> Both are consulted, key
...
public interface ISessionAuthenticator
{
    ...
    /// token resolves to <see cref="CredentialResolutionOutcome.Rejected"/> —
    /// never to <see cref="CredentialResolutionOutcome.NotConfigured"/>, which means something
    ...
    Task<CredentialResolution> AuthenticateAsync(
